...
import com.runescape.animations.FrameBase;
...
public class Model extends Renderable {
	...
	private void rescale() {
		for (int index = 0; index < numVertices; index++) {
			vertexX[index] = vertexX[index] / 4;
			vertexY[index] = vertexY[index] / 4;
			vertexZ[index] = vertexZ[index] / 4;
		}
	}
